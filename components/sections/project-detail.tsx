...
// Detail panel that opens inside the Our Work section when a project
// card is clicked (Figma "portfolio page" frames).
export const ProjectDetail = ({ project, category, onClose }: ProjectDetailProps) => (
  <div className="project-detail relative bg-portfolio-cream text-foreground rounded-2xl p-6 md:p-10 mt-8">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 items-start">
      ...
      <div>
        ...
        <h3 className="font-light text-3xl md:text-4xl mt-2">{project.title}</h3>
